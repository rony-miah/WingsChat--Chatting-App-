            ...
            <div className='flex'> 
                <div className='w-full sm:w-1/2 sm:flex sm:justify-end mx-[10px] sm:mx-[50px] mt-[60px] sm:mt-[10px] md:mt-[60px] sm:mr-[20px]  md:mr-[69px]'>
                    <div>
                        ...
                        <div className='relative mt-[39px] sm:mt-4 md:mt-[39px]'>
                            <input onChange={handlePassword} className='w-full md:w-[368px] py-[20px] sm:py-[10px] md:py-[20px] pl-[35px] sm:pl-[52px] pr-[35px] sm:pr-[65px] border border-[#b7b9ce] rounded-[8.6px] focus:outline-none sm:text-sm md:text-base' type={!passwordshow ? 'text' : 'password'} placeholder='Password' />
